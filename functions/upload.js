    ...
    try {
        ...
        if (!env.IMG) {
            ...
            try {
                ...
                console.error('Error in rating or insertImageData:', e);
        ...
        console.error('Error in fetching image:', e);
...
async function getRating(ratingApi, src) {
    try {
        ...
        console.error('Error in getRating:', e);
        throw e;
    }
}
...
async function insertImageData(env, src, fileName, referer, ip, rating, time) {
    try {
        ...
        console.error('Error in insertImageData:', error);
    }
}
